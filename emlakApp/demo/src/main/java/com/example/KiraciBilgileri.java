...
public class KiraciBilgileri extends JFrame {

        public KiraciBilgileri() {
            setTitle("Kiracı Bilgileri");
            ...
            for (String kiraci : EmlakKiraTakip.kiracilar.keySet()) {
                ...
                textArea.append(kiraci + " - Kira Bedeli: " + kiraBedeli + " TL - Ödeme Tarihi: " + kiraTarihi + "\n");
            }
